...
@section('content')
    ...
    <div class="row placeholders">
        ...
        <a href="{{route('admin.get.list.rating')}}"><div class="col-xs-6 col-sm-3 placeholder" style="position: relative">
            <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="170" height="170" class="img-responsive" alt="Generic placeholder thumbnail">
        ...
        <a href="{{route('admin.get.list.user')}}"><div class="col-xs-6 col-sm-3 placeholder" style="position: relative">
            <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="170" height="170" class="img-responsive" alt="Generic placeholder thumbnail">
    ...
    <div class="row">
        ...
        <div class="col-sm-6"> 
            <a href="{{route('admin.get.list.rating')}}"><h2 class="sub-header">Danh sách đánh giá mới nhất</h2></a>
            <table class="table table-striped">
                <thead>
                <tr>
                    <th>#</th>
