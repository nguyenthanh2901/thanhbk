                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="single-product ex-pro">
                                ...
                                <div class="product-content">
                                     @if ($hot->pro_sale)
                                        <span class="product-name" style="text-decoration: line-through;color: #666;font-weight: 500;">{{ number_format($hot->pro_price,0,',','.') }} đ</span>
                                        <span class="product-name">{{ number_format(round((100 - $hot->pro_sale) * $hot->pro_price / 100,0),0,',','.') }} đ</span>
                                    @else
